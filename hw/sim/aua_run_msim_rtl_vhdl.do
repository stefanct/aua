...
add wave -divider IF/Cache
add wave -hex	/aua_tb/aua1/cmp_if/instr_addr
add wave		/aua_tb/aua1/cmp_if/instr_valid
add wave -hex	/aua_tb/aua1/cmp_if/instr_data

add wave -divider CACHE(direct-mapped)
#~ add wave -hex	/aua_tb/aua1/cmp_icache/test
#~ add wave -hex	/aua_tb/aua1/cmp_icache/testr
#~ add wave -hex	/aua_tb/aua1/cmp_icache/id_instr
...
#~ add wave		/aua_tb/aua1/cmp_icache/mmu_enable
...
add wave sim:/aua_tb/aua1/cmp_uart/rdrf
...
add wave		/aua_tb/aua1/rxd


add wave -divider DIGITS
add wave -hex	/aua_tb/aua1/cmp_digits/digit0_pins
add wave -hex	/aua_tb/aua1/cmp_digits/digit1_pins
add wave -hex	/aua_tb/aua1/cmp_digits/digit2_pins
add wave -hex	/aua_tb/aua1/cmp_digits/digit3_pins
add wave -hex	/aua_tb/aua1/cmp_digits/digit4_pins
add wave -hex	/aua_tb/aua1/cmp_digits/digit5_pins

add wave -divider SWITCHES
add wave -hex	/aua_tb/aua1/cmp_switches/address
add wave		/aua_tb/aua1/cmp_switches/rd
add wave -hex	/aua_tb/aua1/cmp_switches/rd_data
add wave -hex	/aua_tb/aua1/cmp_switches/switch_pins
add wave		/aua_tb/aua1/cmp_switches/wr
add wave -hex	/aua_tb/aua1/cmp_switches/wr_data
view structure
view signals
run -all
